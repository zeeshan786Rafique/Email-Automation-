...
# Resend Key (Apni key yahan paste karein)
resend.api_key = "re_Hgqx8wJP_Lj1mYQTvR8Lt6MiFoPxvNJvA"
# Scheduler ko initialize karein
...
def send_welcome_email(to_email, user_name):
    try:
        params = {
            ...
            "to": to_email,
            "subject": "Email from Email Automation",
            "html": f"<strong>Hi {user_name},</strong><br> This email generated by Email Automation....!"}
...
async def register_user(user: UserData):
    try:
        ...
        # --- PHASE 3 START ---
        # Foran email bhejne ke liye function call karein
